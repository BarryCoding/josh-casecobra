...
import { WEEKLY_GOAL, MONTHLY_GOAL } from '@/constants'
import { db } from '@/db'
...
export default async function Page() {
  ...
  const ADMIN_EMAIL = process.env.KINDE_ADMIN_EMAIL

  // Non-admins can't access this page
  if (!user || user.email !== ADMIN_EMAIL) return notFound()

  // REFACTOR: where should I put the db logic?
  ...
  // FIXME: not DRY, current week and current month
...
// shadcn card `pnpm dlx shadcn-ui@latest add card`
// shadcn table `pnpm dlx shadcn-ui@latest add table` @tanstack/react-table
// LEARN: prisma: findMany + aggregate
