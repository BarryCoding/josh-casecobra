...
export const ThankYou = () => {
  ...
  // 2 not-yet-paid state: wait for Stripe webhook to trigger
  if (data === false) {
    return (
      <div className='mt-24 flex w-full justify-center'>
        <div className='flex flex-col items-center gap-2'>
    ...
    <div className='bg-white'>
      <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
        <div className='w-full'>
          ...
          <p className='mt-12 text-balance text-4xl font-bold tracking-tight sm:text-5xl'>
        ...
        <div className='mt-10 border-t border-zinc-200'>
          <div className='mt-10 flex flex-auto flex-col'>
            ...
            <p className='mt-2 text-sm text-zinc-600'>
              ...
              also last you for the years to come. We offer a 5-year print guarantee: If you case
